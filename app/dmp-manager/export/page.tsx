        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <p className="text-gray-600">
              На этой странице вы можете экспортировать данные из системы в формате Excel
              или импортировать новые данные.
            </p>
          </CardContent>
        </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-500 mb-4">
                Функциональность импорта данных находится в разработке и будет доступна в ближайшее время.
              </p>
